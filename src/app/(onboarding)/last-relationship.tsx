...
export default function LastRelationshipScreen() {
	...
	const handleContinue = () => {
		console.log("Last relationship ended on:", { day, month, year });
		router.push("/(onboarding)/relationship-duration" as any);
	};
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.titleSection}>
				<Text style={styles.title}>Last Relationship Ended</Text>
