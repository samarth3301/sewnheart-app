...
const REASON_OPTIONS = [
  ...
  { id: "life-goals", label: "Life Goals" },
  { id: "long-distance", label: "Long Distance" },
  { id: "finances", label: "Finances" },
  { id: "abusive", label: "Abusive" },
  { id: "career-conflicts", label: "Career conflicts" },
  { id: "cheating", label: "Cheating" },
  { id: "other", label: "Other Reasons", fullWidth: true },
];

export default function BreakupReasonScreen() {
  ...
  const handleContinue = () => {
    if (selectedId) {
      console.log("Breakup reason selected:", selectedId);
      router.push("/(onboarding)/terms-and-conditions" as any);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} bounces={false}>
        <View style={styles.titleSection}>
          <Text style={styles.title}>Breakup Reason</Text>
